import { ArgumentMetadata, ConflictException, NotFoundException, Injectable, CanActivate, ExecutionContext, PipeTransform} from '@nestjs/common';
import { ApplicationServiceURL } from '@project/core';
import { HttpService } from '@nestjs/axios';

import { PublicationService } from '@project/publication-module';
